...
export function __wbg_set_numericproperty_state_none(a: number, b: number): void;
export function __wbg_get_numericproperty_state_live(a: number): number;
export function __wbg_set_numericproperty_state_live(a: number, b: number): void;
export function __wbg_get_numericproperty_state_path(a: number): number;
export function __wbg_set_numericproperty_state_path(a: number, b: number): void;
export function __wbg_get_numericproperty_state_dead(a: number): number;
export function __wbg_set_numericproperty_state_dead(a: number, b: number): void;
...
export function network_get_property(a: number, b: number, c: number, d: number, e: number): number;
...
export function networkbuilder_add_edge_sites(a: number, b: number, c: number, d: number, e: number): number;
